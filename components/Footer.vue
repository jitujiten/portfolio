<template>
    <footer class="bg-[#333] divide-y divide-[#4D4D4D] py-4 px-10">
      <div class="container">
        <div class="flex items-center howItWorks justify-between">
          <div>
            <img src="~/assets/images/logo.png" alt="" class="h-16 rounded-full	">
          </div>
          <div>
      ...
      <div class="container text-center space-y-2">
        <p class="text-white">A Platform by Jitendra Sahu</p>
        <p class="text-sm text-[#959595]">Copyrights Reserved</p>
      </div>
    </footer>
  </template>
